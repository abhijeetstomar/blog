...
# model for comments system
class Comment(models.Model):
    # each post might have multiple comments so we use a foreign key 
    # to connect a comment to a post, we name the relation as comments.
